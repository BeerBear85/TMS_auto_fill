...
class TestProjectData:
    ...
    def test_to_csv_row(self):
        ...
        project = ProjectData(
            ...
            project_text="TD_Academy_Simulator_Transition",
            task="01 - Unspecified"
        )
        ...
        assert row['project_text'] == "TD_Academy_Simulator_Transition"
        assert row['task'] == "01 - Unspecified"
        assert row['monday'] == '0'
    ...
    def test_generate_success(self, tmp_path):
        ...
        projects = [
            ...
            ProjectData(
                ...
                project_text="PR_Engine Commissioning",
                task="01 - Unspecified"
            )
        ]
        ...
        with open(result_path, 'r', encoding='utf-8') as f:
            ...
            assert rows[0]['project_text'] == "TD_Academy_Simulator_Transition"
            assert rows[0]['task'] == "01 - Unspecified"
            assert rows[0]['monday'] == '0'
            assert rows[0]['sunday'] == '0'

            # Check second row
            assert rows[1]['project_number'] == "8-26214-30-01"
            assert rows[1]['project_text'] == "PR_Engine Commissioning"
...
class TestValidateProjectData:
    ...
    def test_validate_valid_data(self):
        ...
        assert project.project_text == 'TD_Academy_Simulator_Transition'
        assert project.task == '01 - Unspecified'

    def test_validate_strips_whitespace(self):
        """Test that whitespace is stripped from fields."""
        data = {
            'project_number': '  8-26214-10-42  ',
            'project_text': '  TD_Academy  ',
            'task': '  01 - Unspecified  '
        }
        ...
        assert project.project_number == '8-26214-10-42'
        assert project.project_text == 'TD_Academy'
        assert project.task == '01 - Unspecified'
